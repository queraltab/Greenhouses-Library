...
model Greenhouse_1
  ...
  Modelica.Fluid.Sensors.Temperature T_ex_2ry(redeclare package Medium =
        Modelica.Media.Water.ConstantPropertyLiquidWater)
    annotation (Placement(transformation(extent={{-28,0},{-20,6}})));
...
equation
  ...
  connect(PID_Mdot.CS, sourceMdot_1ry.in_Mdot) annotation (Line(
      ...
      smooth=Smooth.None,
      pattern=LinePattern.Dash));
  connect(pipe_up.pipe_out, sinkP_2ry.flangeB) annotation (Line(
      points={{-31,-13},{-25.5,-13},{-25.5,-15},{-19.2,-15}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(T_ex_2ry.port, sinkP_2ry.flangeB) annotation (Line(
      points={{-24,0},{-24,-16},{-19.2,-15}},
      color={0,127,255},
      smooth=Smooth.None,
      pattern=LinePattern.Dash));
