...
model Shah1982 "Shah correlation for evaporation"
  ...
  replaceable model LiquidCorrelation =
     Greenhouses.Flows.FluidFlow.HeatTransfer.SinglePhaseCorrelations.DittusBoelter1930
    constrainedby
...
equation
  ...
  psi_nb_trans = Greenhouses.Functions.transition_factor_alt(
    switch=0.3e-4,
    trans=trans*0.3e-4,
    position=Bo);
  ...
  F_hi         = 14.70 "Eq. 11";
  F_lo         = 15.43 "Eq. 12";
  F_trans = Greenhouses.Functions.transition_factor_alt(
    switch=11e-4,
    trans=trans*11e-4,
    position=Bo);
  ...
  N_trans = Greenhouses.Functions.transition_factor(
    start=Fr_l_start,
    stop=Fr_l_stop,
    position=Fr_l);
  N_hi         = Co "Eq. 13";
  ...
  psi_0105_trans = Greenhouses.Functions.transition_factor_alt(
    switch=0.1,
    trans=trans*0.1,
    position=N);
  psi_0105_hi    = psi_N05;
  ...
  psi_0510_trans = Greenhouses.Functions.transition_factor_alt(
    switch=1,
    trans=trans*1,
    position=N);
  psi_0510_hi    = psi_N10;
  ...
  psi_trans = Greenhouses.Functions.transition_factor_alt(
    switch=0.5,
    trans=trans*0.5,
    position=N);
  psi_hi    = psi_0510;
