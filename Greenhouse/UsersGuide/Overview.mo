...
<p><big><br>The connectors used in the library are compatible with the interfaces of the Modelica Standard Library. The library makes use of some models from the ThermoCycle library for the modelling of fluid flow. The ThermoCycle library can be found here: <a href=\"http://thermocycle.net\">http://thermocycle.net</a></p>
</html>"));
end Overview;
